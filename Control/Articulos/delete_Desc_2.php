      ...
      <div align="center"> 
        <p><font face="Arial, Helvetica, sans-serif" color="#0000FF"> 
          <?php
			...
			mysql_query("Delete From Descs_esp Where Ref=" . $Eliminar_Art_2 ,$link);	
...
function backyF ()
{
  ...
  <p align="right"><font face="Arial, Helvetica, sans-serif" color="#0000FF"><a href="articulos.php"><img src="../../images/_Back.jpg" width="67" height="35" name="backy"  border="0"></a></font></p>
</div>
</body>
</html>