    ...
    <td colspan="2" height="39"> 
      <div align="center"><font face="Arial, Helvetica, sans-serif" color="#0000FF"> 
        <?php
		  ...
		  $result=mysql_query("Select * From Descs_esp Group By Ref",$link);	
		  ...
		  echo "<table width='100%' border='1'>";
			...
			{ 
				...
				echo "<tr>";
					...
					echo "</td>";
					echo "<td>";
					echo "<a href='Desc_Mod.php?Mod_Art=" .  $StrTmp . "'>Modificar</a>"; 
					echo "</td>";
					echo "<td>";
					echo "<a href='delete_Desc.php?Eliminar_Art=" .  $StrTmp . "'>Eliminar</a>"; 
					echo "</td>";
            	echo "</tr>";
