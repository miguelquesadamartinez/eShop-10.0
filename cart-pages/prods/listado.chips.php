    ...
    <td height="71"><table align="center" width="100%" cellspacing="0" cellpadding="0" border="0" height="26">
        <tr>
          <td bgcolor="#FFFFFF" height="13">
            <div align="center">
              <table align=center width="700" cellspacing="0" cellpadding="0" border="0" height="72">
                <tr>
                  <td height="24">
...
$str2=".jpg";
	...
	$result=mysql_query("select * from prods Where Grupo='" . $grupo . "'",$link); 

if (!($otrolink=mysql_connect("nelosa.net","nelosa","mqm1804")))    { 
      echo "Error conectando a la base de datos."; 
      exit(); 
   } 
    if (!mysql_select_db("nelosa_net_textos",$otrolink))    { 
	...
	if ($precio != 0 )
	{
		  ...
		  echo "<tr><td>";
			  echo "<table width='95%' border=1 align='center'>";
				echo "<tr>";
				  echo "<TD height=175 align='left' width='55%'><b><font color='#0000FF' face='Arial, Helvetica, sans-serif'>$strTmp - $strDes</b><br>$desi</font>  "; 
				  echo "<TD align='center' width='25%'> <IMG SRC='../images/productos/" . $strTmp  . ".jpg' >";
				  echo "<TD align='center' width='20%'>";
					echo "<form action='index-prods.php' target='_blank' align='center'>";
					echo "<input type=hidden name='item' align='center' value='" . $strTmp  . "'>";
					echo "<br><p align='center'>" . $row["precio_eshop"] . " €  ";
